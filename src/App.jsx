          ...
          <div style={{ marginTop:28 }}>
            ...
            <div style={{ background:CARD, border:`1px solid ${BORDER}`, borderRadius:16, padding:"24px" }}>
              ...
              {[
                ...
                ["Can I get a refund?","If you haven't used any credits, contact us within 7 days for a full refund."],
              ].map(([q,a],i)=>(
                <div key={i} style={{ marginBottom:i<3?18:0, paddingBottom:i<3?18:0, borderBottom:i<3?`1px solid ${BORDER}`:"none" }}>
